...
namespace MyApp
{
    class Program
    {
        static void Main(string[] args)
        {
                ...
                float myFloat = 0.751f; // f is required to specify it is a float
                float mySecondFloat = 0.75f;
     
                // 8 byte (64 bit) floating point number
                double myDouble = 0.751;
                double mySecondDouble = 0.75d; // d is optional to specify it is a double
     
                // 16 byte (128 bit) floating point number
                decimal myDecimal = 0.751m; // m is required to specify it is a decimal
